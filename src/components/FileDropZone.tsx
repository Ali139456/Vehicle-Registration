        ...
        className={`
          ...
          ${file
            ...
            : dragActive
              ...
              : 'border-[var(--border)] bg-[var(--surface-elevated)]/50 hover:border-slate-500/60 hover:bg-[var(--surface-elevated)]'}
        `}
      >
        <input
          type="file"
        ...
        />
        {icon && (
          <span className={file ? 'text-emerald-500/80' : 'text-slate-500'}>
            {icon}
          </span>
        )}
        {file ? (
